    ...
    function build_emp_table(result) {
        ...
        $.each(emps, function (index, item) {
            ...
            $("<tr></tr>").append(empIdTd).append(empNameTd).append(empGenderTd)
                .append(empEmailTd).append(empDeptTd)
                .append(editBtn).append(delBtn).append(btnTd)
    ...
    function getDepts(ele) {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $.each(result.data.deptList, function () {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (result.code == 100) {
                    ...
                    show_validate_msg("#empName_add_input", "error", result.data.valid);
